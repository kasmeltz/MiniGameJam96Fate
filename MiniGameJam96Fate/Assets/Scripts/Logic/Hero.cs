...
namespace HairyNerdStudios.GameJams.MiniGameJam96.Unity.Logic
{
    public class Hero
    {
        ...
        {
            [HeroUpgradeType.MovementSpeed] = new float[] { 0.02f, 0.04f, 0.06f, 0.08f, 0.10f, 0.12f, 0.14f, 0.16f, 0.24f, 0.32f },
            [HeroUpgradeType.WallSmashRecovery] = new float[] { 0.2f, 0.25f, 0.35f, 0.5f, 0.7f, 0.95f, 1.25f, 1.75f, 2f, 2.5f },
